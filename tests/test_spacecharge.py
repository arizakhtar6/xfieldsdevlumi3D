...
def test_spacecharge_gauss_qgauss(frozen, test_context):
    ...
    from xfieldsdevlumi.test_support.temp_makepart import generate_particles_object
    ...
    from xfieldsdevlumi import LongitudinalProfileQGaussian
    ...
    from xfieldsdevlumi import SpaceChargeBiGaussian
...
def test_spacecharge_pic(solver, test_context):
    ...
    from xfieldsdevlumi import SpaceCharge3D
